...
def index(request):
    ...
    caraousel = Project.objects.order_by('-overall_score')[2]
    nominees=Project.objects.all()[4:8]
    directories=Project.objects.all()[8:12]
    resources=Project.objects.all()[12:15]
...
def directory(request):
    ...
    return render(request,'directory.html',{"winners":winners,"profile":profile,"date":date, "caraousel":caraousel})
